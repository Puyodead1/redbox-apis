...
export const post = [
    ...
    async (req: Request, res: Response) => {
        ...
        logger.info(`GetCertificates for kioskId: ${kioskId}, type: ${thingType}, kioskPassword: ${password}`);
        ...
        logger.debug(`Generated certificate for kioskId: ${kioskId}, certificateId: ${certificate.certificateId}`);
